...
import { And, DataSource, EntityManager, Equal, MoreThanOrEqual, Not } from 'typeorm';
...
export class TrainingApprovalsService extends CrudHelper<TrainingApproval> {
  ...
  /* find training approval by id */
  async findApprovalsByTrainingId(trainingId: string) {
    try {
