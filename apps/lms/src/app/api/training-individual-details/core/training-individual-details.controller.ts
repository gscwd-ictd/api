...
@Controller({ version: '1', path: 'training-individual-details' })
export class TrainingIndividualDetailsController {
  constructor(private readonly trainingIndividualDetailsService: TrainingIndividualDetailsService) {}

  // HR

  //post method for creating a training and distribution of slots
  @Post()
  async create(@Body() data: CreateTrainingIndividualDetailsDto) {
    return await this.trainingIndividualDetailsService.addTraining(data);
  }
