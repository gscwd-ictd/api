...
export class CreateLspIndividualDetailsDto {
  ...
  @Length(1, 100, { message: 'lsp individual details first name must be between 1 to 100 characters' })
  firstName: string;

  @IsString({ message: 'lsp individual details middle name must be a string' })
  @Length(1, 100, { message: 'lsp individual details middle name must be between 1 to 100 characters' })
  middleName: string;

  @IsString({ message: 'lsp individual details last name must be a string' })
  @Length(1, 100, { message: 'lsp individual details last name must be between 1 to 100 characters' })
  lastName: string;
