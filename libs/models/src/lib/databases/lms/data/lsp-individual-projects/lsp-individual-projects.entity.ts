...
@Entity({ name: 'lsp_individual_projects' })
export class LspIndividualProject extends DatabaseEntity implements IEntity {
  @PrimaryGeneratedColumn('uuid', { name: 'lsp_individual_project_id' })
  id: string;
