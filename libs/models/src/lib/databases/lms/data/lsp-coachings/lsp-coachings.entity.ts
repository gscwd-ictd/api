...
@Entity({ name: 'lsp_coachings' })
export class LspCoaching extends DatabaseEntityWithTimezone implements IEntity {
  @PrimaryGeneratedColumn('uuid', { name: 'lsp_coaching_id' })
  id: string;
