...
@Entity({ name: 'lsp_organization_projects' })
export class LspOrganizationProject extends DatabaseEntity implements IEntity {
  @PrimaryGeneratedColumn('uuid', { name: 'lsp_organization_project_id' })
  id: string;
