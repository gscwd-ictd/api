...
@Entity({ name: 'lsp_organization_coachings' })
export class LspOrganizationCoaching extends DatabaseEntity implements IEntity {
  @PrimaryGeneratedColumn('uuid', { name: 'lsp_organization_coaching_id' })
  id: string;
