...
@Entity({ name: 'lsp_organization_certifications' })
export class LspOrganizationCertification extends DatabaseEntity implements IEntity {
  @PrimaryGeneratedColumn('uuid', { name: 'lsp_organization_certification_id' })
  id: string;
